...
public class JTablePanier extends JTable {
	...
	private final TableModelPanier model;
	...
	public JTablePanier(){
		...
		addJLabel.setToolTipText("Ajouter un livre au panier");
