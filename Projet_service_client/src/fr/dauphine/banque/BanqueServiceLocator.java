...
public class BanqueServiceLocator extends org.apache.axis.client.Service implements fr.dauphine.banque.BanqueService {
    ...
    private java.lang.String Banque_address = "http://localhost:8080/Projet_service_web_banque/services/Banque";
    ...
    public fr.dauphine.banque.Banque getBanque(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.dauphine.banque.BanqueSoapBindingStub _stub = new fr.dauphine.banque.BanqueSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.dauphine.banque.Banque.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.dauphine.banque.BanqueSoapBindingStub _stub = new fr.dauphine.banque.BanqueSoapBindingStub(new java.net.URL(Banque_address), this);
                _stub.setPortName(getBanqueWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://banque.dauphine.fr", "BanqueService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://banque.dauphine.fr", "Banque"));
        }
