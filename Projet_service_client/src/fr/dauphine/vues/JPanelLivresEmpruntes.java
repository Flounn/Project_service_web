...
public class JPanelLivresEmpruntes extends JPanel {

	private static final long serialVersionUID = 1L;
	private JTableLivres livresEmpruntes; 

	public JPanelLivresEmpruntes(){
		initUi();
	}
	...
	private void initUi(){
		...
		lblTitre = new JLabel("Livres empruntes");
		...
		panel_1.add(new JScrollPane(livresEmpruntes));
	}
