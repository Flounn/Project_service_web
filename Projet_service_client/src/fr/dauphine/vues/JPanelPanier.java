...
public class JPanelPanier extends JPanel {

	private static final long serialVersionUID = 1L;
	private JTableLivres panier;
	...
	private void initUi(){
		...
		panier = new JTableLivres("Livres",new TableModelPanier());  
		
		panel_1.add(new JScrollPane(panier));
	}
	
	public void refreshJTable(){
		((AbstractLivresTableModel)panier.getModel()).resfreshData();
	}
	
	public void refreshJTableHeader(){
		panier.refreshHeader();
	}
